...
function Footer() {
  ...
  <div className="container bg-[#7168AF] flex justify-between items-center text-white flex-col md:flex-row">
    <div className="logo ml-7 mt-5">
      ...
      <a href="https://facbook.com"> <img className='w-9 ml-3' src={facbook} alt="" /></a>
      <div className="flex">
      <a href="https://facbook.com"> <img className='w-10 ml-3' src={instagram} alt="" /></a>
      <p className='ml-13 text-[#FBAD27] text-bold'>All Social Media</p>
      </div>
      <a href="https://facbook.com"> <img className='w-10 ml-3' src={twitter} alt="" /></a>
    </div>

    <div className="links flex flex-col gap-1 m-5">
      <h3 className='text-500 font-bold'>Quick links</h3>
      <a href="Product">Product</a>
      <a href="Product">Trainers</a>
      <a href="Product"> Princing</a>
      <a href="Product">Members</a>
