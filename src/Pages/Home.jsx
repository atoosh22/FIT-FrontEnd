...
function Hero(){
  return(
    <>
       ...
       <h2 className='font-bold text-4xl font-[roboto]'>Perfect Workout <br/><span className='text-[#82b6a8]'>Coach For Body Shape</span></h2>
       <p className='font-[Poppins] py-2 mb-6'>Quisque leo augue, lobortis ac tellus nec, posuere ultricies nulla. <br/> Praesent massa odio,
        ...
        <a className='bg-[#023047] rounded-lg px-4 py-2  text-white hover:bg-[#82b6a8]' href="#">Read More</a>
       </div>
       <div className="img">
       ...
       <div className=" flex gap-10 justify-center bg-white mx-10 shadow-lg rounded-lg p-5 flex-col md:flex-row">
        ...
        <ion-icon name="location-outline" className="text-4xl text-[#82b6a8]"></ion-icon>
          <p>Choose your location</p>
        </div>

        {/* 2 */}
        <div className="flex gap-2">
        <ion-icon name="calendar-outline" className="text-3xl text-[#82b6a8]"></ion-icon>
        ...
        <div className="flex gap-2">
        <ion-icon name="barbell-outline" className="text-3xl text-[#82b6a8]"></ion-icon>
          <p>Choose Your GYM</p>
        </div>
        {/* 4 */}

        <div className="flex gap-2">
        <ion-icon name="person-outline" className="text-3xl text-[#82b6a8]"></ion-icon>
  ...
  return (
    <div className="container flex justify-between flex-col md:flex-row mt-71" data-aos="fade-right">
      ...
      <div className="text mr-10 ">
        ...
        <a className='bg-[#023047] text-white mt-10 px-3 py-2 shadow-lg rounded-lg hover:bg-[#82b6a8]' href="#">Read More</a>
      </div>
    </div>
  );
}
    ...
    <>
      ...
      <div className="flex gap-6 bg-gray-100 md:w-full mt-14 py-3 text-center">
        <div className="flex gap-5 md:gap-[180px] px-10">
          <button className='bg-[#82b6a8] text-white px-3 shadow-lg rounded-lg hover:bg-[#023047]'>Monday</button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-6 my-15 mx-10">
        <div className="shadow-lg bg-gray-150 p-10">
          ...
          <p>Rachel Adam</p>
          <button className='bg-[#023047] text-white px-3 shadow-lg rounded-lg hover:bg-[#82b6a8] my-4'>06AM-08AM</button>
        </div>
        <div className="shadow-lg bg-gray-150 p-10">
